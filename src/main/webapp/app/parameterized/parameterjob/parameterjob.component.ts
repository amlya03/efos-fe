...
@Component({
  selector: 'jhi-parameterjob',
  templateUrl: './parameterjob.component.html',
  styleUrls: ['./parameterjob.component.scss'],
})
export class ParameterjobComponent implements OnInit {
