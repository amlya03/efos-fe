...
export class DataCalonNasabahComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.dataCalonNasabahForm = this.formBuilder.group({
      ...
      note_verif_alamat: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      verif_rt_rw: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      note_verif_rt_rw: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      ...
      note_verif_tanggal_lahir: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      verif_pendidikan: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      note_verif_pendidikan: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      verif_status_menikah: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      note_verif_status_menikah: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      verif_ibu_kandung: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      note_verif_ibu_kandung: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      // verif_jumlah_tanggungan: '',
      // note_verif_jumlah_tanggungan: '',
      verif_nama_pasangan: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      note_verif_nama_pasangan: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      verif_pekerjaan_pasangan: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      note_verif_pekerjaan_pasangan: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      fasilitas_pembiayaan: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      karakter_calon_nasabah: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      status_rumah: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      // cek: '',
      ...
      // ]),
      rumah_dihuni: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      lama_menetap_bulan: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      lama_menetap_tahun: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      jenis_bangunan: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      lokasi_perumahan: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      fasilitas_listrik: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      // isi_rumah: '',
      kondisi_lingkungan: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      akses_jalan: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      garasi: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      carport: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      kendaraan: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      jumlah_kendaraan: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      kondisi_kendaraan: [{ value: !null || null, disabled: this.verifikatorMelihat }],
      // created_date: "",
      // updated_date: "",
      // created_by: "",
      // updated_by: ""
