...
export class DataRumahComponent implements OnInit {
  ...
  onSubmit(): void {
    ...
    const pend_bersih = Number(this.analisaKeuanganForm.get('pendapatan_bersih')?.value) + Number(this.analisaKeuanganForm.get('pendapatan_bersih_pasangan')?.value);
    ...
    const pend_kotTot = Number(this.analisaKeuanganForm.get('pendapatan_kotor')?.value) + Number(this.analisaKeuanganForm.get('pendapatan_kotor_pasangan')?.value);
