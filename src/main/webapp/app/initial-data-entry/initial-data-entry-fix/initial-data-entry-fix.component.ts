    ...
    if (this.status_perkawinan == 'Menikah') {
      ...
      this.http
        .post<any>('http://10.20.34.110:8805/api/v1/efos-ide/create_app_ide', {
          ...
          nama_pasangan: this.dataentryfixfom.get('nama_pasangan')?.value,
          kategori_pekerjaan: 'Fix Income',
          curef: getcuref,
          jenis_kelamin: this.dataentryfixfom.get('jenis_kelamin')?.value,
          jenis_kelamin_pasangan: this.dataentryfixfom.get('jenis_kelamin_pasangan')?.value,
          usia: this.dataentryfixfom.get('umurform')?.value,
          app_no_ide: getappide,
          tanggal_lahir: this.dataentryfixfom.get('tanggallahirpasangan')?.value,
          tanggal_lahir_pasangan: this.dataentryfixfom.get('umurform')?.value,
