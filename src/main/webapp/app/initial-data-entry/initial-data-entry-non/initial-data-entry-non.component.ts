  ...
  carimenggunakankodepostj(kodepost:any,req:any){
    ...
    this.getkodepostnya(kodepost, req).subscribe({
      next: (res: EntityArrayResponseDaWa) => {
        ...
        $('#kabkota_perusahaan').attr('selected', 'selected').val(this.kabkota_perusahaankode + '|' +    this.kabkota_perusahaan);

        $('#kecamatan_perusahaan').attr('selected', 'selected').val(this.kecamatan_perusahaankode + '|' +    this.kecamatan_perusahaan);
        $('#kecamatan_perusahaan option:first').text(this.kecamatan_perusahaan);

        $('#kelurahan_perusahaan').attr('selected', 'selected').val(this.kelurahan_perusahaankode + '|' +    this.kelurahan_perusahaan);
  ...
  carimenggunakankodepostp(kodepost:any,req:any){
    ...
    this.getkodepostnyap(kodepost, req).subscribe({
      next: (res: EntityArrayResponseDaWa) => {
        ...
        $('#kabkota_cabang_pasangan').attr('selected', 'selected').val(this.kabkota_cabang_pasangankode + '|' +    this.kabkota_cabang_pasangan);
