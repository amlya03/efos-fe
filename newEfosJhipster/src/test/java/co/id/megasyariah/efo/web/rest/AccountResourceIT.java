...
import static co.id.megasyariah.efo.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import co.id.megasyariah.efo.config.Constants;
import co.id.megasyariah.efo.domain.PersistentToken;
import co.id.megasyariah.efo.domain.User;
import co.id.megasyariah.efo.repository.AuthorityRepository;
import co.id.megasyariah.efo.repository.PersistentTokenRepository;
import co.id.megasyariah.efo.repository.UserRepository;
import co.id.megasyariah.efo.security.AuthoritiesConstants;
import co.id.megasyariah.efo.service.UserService;
import co.id.megasyariah.efo.service.dto.AdminUserDTO;
import co.id.megasyariah.efo.service.dto.PasswordChangeDTO;
import co.id.megasyariah.efo.service.dto.UserDTO;
import co.id.megasyariah.efo.web.rest.vm.KeyAndPasswordVM;
import co.id.megasyariah.efo.web.rest.vm.ManagedUserVM;
